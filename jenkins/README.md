# UQ Jenkins Docker image (official image fork)
...
```
    docker build -t uqjenkins .
```

# Usage

```
docker run -p 8080:8080 -p 50000:50000 uqjenkins
```
...
```
docker run -p 8080:8080 -p 50000:50000 -v jenkins_home:/var/jenkins_home uqjenkins
```
...
```
docker run --name myjenkins -p 8080:8080 -p 50000:50000 --env JAVA_OPTS=-Dhudson.footerURL=http://mycompany.com uqjenkins
```
...
```
docker run --name myjenkins -p 8080:8080 -p 50001:50001 --env JENKINS_SLAVE_AGENT_PORT=50001 uqjenkins
```
